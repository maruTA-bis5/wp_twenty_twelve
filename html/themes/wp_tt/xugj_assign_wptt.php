...
include_once dirname(__FILE__).'/xugj_menu_lang.php';
$xugj_menu_uls = xugj_assign_display_menu_ul_recursively( $united_menus ) ;
$xugj_menu_uls = preg_replace('/^<ul>/', '<ul>' . _WPTT_TOP_MENU, $xugj_menu_uls, 1);
$this->assign( 'xugj_menu_uls' , $xugj_menu_uls ) ;
